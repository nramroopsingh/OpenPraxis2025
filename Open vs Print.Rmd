...
# 🧭 Define actual factor levels based on your `table()` results
...
# Q6 (Effectiveness w/ “Somewhat effective”)
...
# Q8–Q9 (Contribution: Includes “Very much”, “Moderately”, etc.)
...
# Q16 Preference (no recoding needed — categorical)
# Q17 Distraction
...
# ✅ Now all Likert variables are correctly ordered and ready for analysis!
...
The comparison of overall textbook satisfaction between students who used online versus traditional textbooks revealed broadly similar patterns, with no statistically significant difference (p = 0.396). However, the proportional bar chart shows that a greater percentage of students using online textbooks reported being “Very Satisfied” compared to those using traditional materials.

While “Moderately Satisfied” was the most common response across both groups, traditional users tended to cluster more heavily in that category, whereas online users showed greater variation—including a higher percentage in both “Very Satisfied” and “Slightly Satisfied” categories.
...
Why Accessibility?
It’s directly related to usability and inclusiveness
...
The analysis revealed a statistically significant difference in perceived textbook accessibility between students using online versus traditional textbooks (Wilcoxon rank-sum test, W = 768.5, p = 0.013). Students who used online textbooks reported significantly higher levels of accessibility, with a greater proportion selecting “Very Accessible” or “Extremely Accessible” compared to their peers using traditional print materials.
...
```
While the chi-square test revealed no statistically significant difference between textbook type and future textbook preference (χ²(3) = 1.74, p = .63), the visual trends offer meaningful insights.
...
These findings support the argument that online textbooks are not only accessible and satisfactory, but also align with students’ evolving preferences for future learning environments.
...
To simplify and strengthen the analysis of students’ future textbook preferences, responses were recoded into two categories: “Digital-friendly” (open online textbook or both) and “Traditional-only”. This binary classification aligns directly with the study’s research question and avoids the limitations of small cell sizes encountered in the original chi-square test.

A Fisher’s Exact Test was performed, which revealed no significant association between the textbook type students used and their preferred format for future courses (p = 1.00, OR = 1.01, 95% CI = [0.23, 4.05]).
...
A small effect size (Cohen’s d = -0.25) indicated a very slight, non-significant trend favoring traditional textbook users; however, the magnitude of this difference was negligible.
...
| Academic Performance (Effect Size) | Cohen’s *d*         | *d* = -0.25 (small) | Negligible difference, slightly favoring traditional |
